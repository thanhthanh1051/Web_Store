            ...
            <li class="nav-item">
                ...
                <div id="categories" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{route('admin.categories.getList')}}">Show List</a>
                        <a class="collapse-item" href="{{route('admin.categories.getAdd')}}">Add New</a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
                ...
                <div id="Brands" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{route('admin.brands.getList')}}">Show List</a>
                        <a class="collapse-item" href="{{route('admin.brands.getAdd')}}">Add New</a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Admin Ne`</span>
                                <img class="rounded-circle" src="https://source.unsplash.com/Mv9hjnEUHR4/60x60"
                                            alt="..." width="30%">
                            </a>
